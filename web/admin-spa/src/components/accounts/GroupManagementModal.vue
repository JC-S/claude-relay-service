                ...
                ? tab.key === 'claude'
                  ...
                  : tab.key === 'gemini'
                    ...
                    : tab.key === 'droid'
                      ...
                      : tab.key === 'grok'
                        ? 'bg-slate-200 text-slate-800 dark:bg-cyan-950/40 dark:text-cyan-300'
...
const platformTabs = [
  ...
  { key: 'grok', label: 'Grok', color: 'slate' }
]
...
const platformBadgeClasses = {
  ...
  grok: 'bg-slate-200 text-slate-800 dark:bg-cyan-950/40 dark:text-cyan-300'
}
